#ifndef _QUIK_CONNECTOR_WRAPTRANS2QUIK_INCLUDED
#define _QUIK_CONNECTOR_WRAPTRANS2QUIK_INCLUDED
...
class QuikApiWrap
{
	public:
		...
		void initCallbacks(PQCCONNECTSTATUSFUN callbackConnectFun, PQCTRANSSTATUSFUN callbackTransactFun);
...
private:
	...
	CppUtils::Mutex callBacksMtx_m;

	PQCCONNECTSTATUSFUN callbackConnectFun_m;

	PQCTRANSSTATUSFUN callbackTransactFun_m;
};
