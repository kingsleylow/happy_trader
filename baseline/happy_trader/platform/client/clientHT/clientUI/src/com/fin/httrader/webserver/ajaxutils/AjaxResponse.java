...
public class AjaxResponse {
    ...
    private String customData_m = null;
    ...
    public String createJson() {
        ...
        if (customData_m != null)
					obj.put("custom_data", customData_m);
				else
					obj.put("custom_data", "");
		...
		public static String serializeToString(String data, String reason, int code)
		{
        ...
        out.append(HtBase64.encode(HtStringByteConverter.encodeUTF8(reason != null ? reason : "")));
        out.append("</status_string>");

        out.append("<data_string>");
        out.append(HtBase64.encode(HtStringByteConverter.encodeUTF8(data != null ? data : "")));
        out.append("</data_string>");
    ...
    public String serializeToXmlString() {
				return serializeToString(getCustomData(),getReason(), getCode() );
    }
