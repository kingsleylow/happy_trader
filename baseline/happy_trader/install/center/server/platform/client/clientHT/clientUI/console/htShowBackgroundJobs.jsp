...
<jsp:useBean id="SC" class="com.fin.httrader.webserver.HtShowBackgroundJobs" scope="request"/>
	...
	<head>
		...
		<script type="text/javascript">
			...
			function usrFun_Navigate(historyBaseUrl, history_pageIndex, pageSize)
			{
				...
				var url = '/HtShowBackgroundJobs_HistoryProvider.jsp?'+
			...
			function initHistoryGridObject()
			{
				...
				historyGrid_m.setHeader("ID, Type, Start Time, Finish Time, Result Code, Result String");
				historyGrid_m.setInitWidths("150,200,120,120,80,400");
