DROP DATABASE `mtrunner`;

CREATE DATABASE `mtrunner` DEFAULT CHARACTER SET utf8;
...
CREATE TABLE `mtrunner`.`account_update` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `mtrunner`.`balance_update` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `account_minfo_id` bigint(20) NOT NULL,
...
CREATE TABLE `mtrunner`.`company_metainfo` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `mtrunner`.`position` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `account_minfo_id` bigint(20) NOT NULL,
...
CREATE TABLE `mtrunner`.`position_update` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
