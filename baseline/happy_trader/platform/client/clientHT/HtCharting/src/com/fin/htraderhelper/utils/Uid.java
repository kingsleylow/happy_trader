...
public class Uid implements Serializable, Comparable<Uid> {
	...
	public String toString() {
		StringBuilder s1 = new StringBuilder(Long.toHexString(getN1()).toUpperCase());
		StringBuilder s2 = new StringBuilder(Long.toHexString(getN2()).toUpperCase());
