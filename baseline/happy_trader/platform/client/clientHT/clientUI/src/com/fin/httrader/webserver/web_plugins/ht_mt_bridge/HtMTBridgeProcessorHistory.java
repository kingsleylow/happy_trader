...
public class HtMTBridgeProcessorHistory extends HtServletsBase {
		...
		public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
				...
				try {
						...
						HtLog.log(Level.WARNING, getContext(), "doPost", "Exception on on HTTP request: " + e.getMessage());
						if (reqObj != null)
				...
				String data;
				if (reqObj != null && reqObj.getSimpleResponseFlag())
					data = ajax_resp.createJson();
				else
					data = ajax_resp.serializeToXmlString();
