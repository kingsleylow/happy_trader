...
import com.mtrunner.client.auth.provider.CustomAuthenticationProvider;
...
public class JoomlaDBUtil {
	...
	public UserToAuthenticate resolveJoomlaUser(String joomlauser) throws Exception
	{
		...
		log_m.debug("resolving joomla user: " + joomlauser);
		...
		log_m.debug("Joomla user resolved: " + user.toString());
