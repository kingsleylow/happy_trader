 ...
 */
public class CustomClassLoader extends SecureClassLoader implements Closeable {
    ...
    CustomClassLoader(URL[] urls, ClassLoader parent, AccessControlContext acc) {
        super(parent);
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
    ...
    CustomClassLoader(URL[] urls, AccessControlContext acc) {
        super();
        // this is to make the stack depth consistent with 1.1
        SecurityManager security = System.getSecurityManager();
        if (security != null) {
    ...
    */
     ...
     */
    public static CustomClassLoader newInstance(final URL[] urls, final ClassLoader parent) 
		{
        // Save the caller's context
        final AccessControlContext acc = AccessController.getContext();
        // Need a privileged block to create the class loader
        CustomClassLoader ucl = AccessController.doPrivileged(
            new PrivilegedAction<CustomClassLoader>() {
                public CustomClassLoader run() {
     ...
     * @return the resulting class loader
     */
    public static CustomClassLoader newInstance(final URL[] urls) {
        // Save the caller's context
        final AccessControlContext acc = AccessController.getContext();
        // Need a privileged block to create the class loader
        CustomClassLoader ucl = AccessController.doPrivileged(
    ...
    static {
        sun.misc.SharedSecrets.setJavaNetAccess (
            new sun.misc.JavaNetAccess() {
								...
								@Override
								public URLClassPath getURLClassPath(URLClassLoader urlcl) {
...
final class FactoryURLClassLoader extends CustomClassLoader {
