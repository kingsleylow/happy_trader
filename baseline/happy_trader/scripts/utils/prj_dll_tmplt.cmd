...
echo 			OutputDirectory=".\../../../lib/win32_i86/Debug"	
...
echo 				Optimization="0"
echo 				AdditionalIncludeDirectories="&quot;$(HT_DEVEL_ROOT)/extern/include&quot;;&quot;$(HT_DEVEL_ROOT)&quot;;&quot;$(HT_DEVEL_ROOT)\extern\msvc\xerces-c-3.1.1\src&quot;"
echo 				PreprocessorDefinitions="_DEBUG;WIN32;_WINDOWS;_USRDLL;%EXPORT_CPP_DEFINITION%;CPPUTILS_DLL;SERVICE_BACKEND_DLLS"
...
echo 				AdditionalDependencies="odbc32.lib odbccp32.lib"
echo 				OutputFile="../../../lib/win32_i86/Debug/%DLL_NAME_DEBUG%"
echo 				Version="2.1"
...
echo 				ProgramDatabaseFile=".\../../../lib/win32_i86/Debug/%PDB_NAME_DEBUG%"
echo 				ImportLibrary=".\../../../lib/win32_i86/Debug/%LIB_NAME_DEBUG%"
echo 				TargetMachine="1"/^>
echo 			^<Tool
echo 				Name="VCMIDLTool"
echo 				PreprocessorDefinitions="_DEBUG"
echo 				MkTypLibCompatible="TRUE"
echo 				SuppressStartupBanner="TRUE"
echo 				TargetEnvironment="1"
echo 				TypeLibraryName=".\../../../lib/win32_i86/Debug/%TLB_NAME%"
echo 				HeaderFileName=""/^>
echo 			^<Tool
echo 				Name="VCPostBuildEventTool"
echo 				Description="Copying DLL"
echo 				CommandLine="copy                ..\..\..\lib\win32_i86\Debug\%DLL_NAME_DEBUG%                ..\..\..\..\..\bin\win32_i86\Debug\"/^>
echo 			^<Tool
...
echo 			OutputDirectory=".\../../../lib/win32_i86/Release"
...
echo 				AdditionalIncludeDirectories="&quot;$(HT_DEVEL_ROOT)/extern/include&quot;;&quot;$(HT_DEVEL_ROOT)&quot;;&quot;$(HT_DEVEL_ROOT)\extern\msvc\xerces-c-3.1.1\src&quot;"
echo 				PreprocessorDefinitions="NDEBUG;WIN32;_WINDOWS;_USRDLL;%EXPORT_CPP_DEFINITION%;CPPUTILS_DLL;SERVICE_BACKEND_DLLS"
...
echo 				Name="VCLinkerTool"
echo 				AdditionalDependencies="odbc32.lib odbccp32.lib"
echo 				OutputFile="../../../lib/win32_i86/Release/%DLL_NAME_RELEASE%"
echo 				Version="2.1"
echo 				LinkIncremental="1"
echo 				SuppressStartupBanner="TRUE"
echo 				AdditionalLibraryDirectories="$(HT_DEVEL_ROOT)/extern/lib/win32_i86/sxl"
echo 				IgnoreDefaultLibraryNames=""
echo				GenerateDebugInformation="TRUE"
echo 				ProgramDatabaseFile=".\../../../lib/win32_i86/Release/%PDB_NAME_RELEASE%"
echo 				ImportLibrary=".\../../../lib/win32_i86/Release/%LIB_NAME_RELEASE%"
echo 				TargetMachine="1"/^>
echo 			^<Tool
echo 				Name="VCMIDLTool"
...
echo 				SuppressStartupBanner="TRUE"
echo 				TargetEnvironment="1"
echo 				TypeLibraryName=".\../../../lib/win32_i86/Release/%TLB_NAME%"
echo 				HeaderFileName=""/^>
echo 			^<Tool
echo 				Name="VCPostBuildEventTool"
echo 				Description="Copying DLL"
echo 				CommandLine="copy                ..\..\..\lib\win32_i86\Release\%DLL_NAME_RELEASE%                ..\..\..\..\..\bin\win32_i86\Release\
echo copy .\..\..\..\lib\win32_i86\Release\%PDB_NAME_RELEASE%                 ..\..\..\..\..\bin\win32_i86\Release\"/>
echo 			^<Tool
echo 				Name="VCPreBuildEventTool"/^>
echo 			^<Tool
echo 				Name="VCPreLinkEventTool"/^>
...
echo 			^<File
echo 				RelativePath="..\..\src\%SUB_DIR%\%GENERAL_IMPLEMENT_CPP_FILE_NAME%"^>
echo 			^</File^>
echo 		^</Filter^>
echo 		^<Filter
echo 			Name="Header Files"
echo 			Filter="h;hpp;hxx;hm;inl"^>
echo 			^<File
echo 				RelativePath="..\..\src\%SUB_DIR%\%GENERALINCLUDE_HEADER_FILE_NAME%"^>
echo 			^</File^>
echo 			^<File
echo 				RelativePath="..\..\src\%SUB_DIR%\%DEFS_HEADER_FILE_NAME%"^>
echo 			^</File^>
echo 			^<File
echo 				RelativePath="..\..\src\%SUB_DIR%\%GENERAL_IMPLEMENT_HEADER_FILE_NAME%"^>
echo 			^</File^>
echo 		^</Filter^>
echo 	^</Files^>
echo 	^<Globals^>
